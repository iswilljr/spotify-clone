...
export const LyricsIcon = ControlIcon({
  icon: (
...
export const QueueIcon = ControlIcon({
  icon: (
    <svg role="img" height="16" width="16" fill="currentColor" viewBox="0 0 16 16">
...
export const DeviceIcon = ControlIcon({
  icon: (
    <svg role="img" height="16" width="16" fill="currentColor" viewBox="0 0 16 16">
...
export const VolumeIcon = ControlIcon({
  icon: (
    <svg role="presentation" height="16" width="16" fill="currentColor" viewBox="0 0 16 16">
